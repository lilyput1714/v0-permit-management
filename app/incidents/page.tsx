...
import { getAllIncidents } from "@/services/data-service"
      ...
      <div className="flex-1 md:ml-64">
        ...
        <div className="py-6 px-4 sm:px-6 md:px-8">
          ...
          <div className="relative mb-4">
            ...
            <Input placeholder="Search incidents by title, location, or type..." className="pl-10 pr-20" />
            <Button
              variant="ghost"
              size="sm"
